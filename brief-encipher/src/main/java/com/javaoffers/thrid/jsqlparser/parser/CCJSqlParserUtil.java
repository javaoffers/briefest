...
public final class CCJSqlParserUtil {
    ...
    public static Expression parseExpression(String expression, boolean allowPartialParse, Consumer<CCJSqlParser> consumer) throws JSQLParserException {
        ...
        try {
            ...
            if (!allowPartialParse && parser.getNextToken().kind != CCJSqlParserTokenManager.EOF) {
                throw new JSQLParserException("could only parse partial com.javaoffers.thrid.sqlparse.expression " + expr.toString());
            }
            return expr;
    ...
    /**
     * Parse an conditional com.javaoffers.thrid.sqlparse.expression. This is the com.javaoffers.thrid.sqlparse.expression after a where
     * clause. Partial parsing is enabled.
     *
     * @param condExpr
     * @return the com.javaoffers.thrid.sqlparse.expression parsed
    ...
    /**
     * @param parser
     * @return the com.javaoffers.thrid.sqlparse.statement parsed
      ...
      for (char c:chars) {
          switch(c) {
              ...
              case ')':
                ...
                break;
              default:
                // Codazy/PMD insists in a Default com.javaoffers.thrid.sqlparse.statement
          }
      }
      return maxlevel;
    }
