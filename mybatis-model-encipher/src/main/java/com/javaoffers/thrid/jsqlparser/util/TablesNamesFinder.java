...
import com.javaoffers.thrid.jsqlparser.expression.operators.conditional.XorExpression;
...
/**
 * Find all used tables within an select com.javaoffers.thrid.sqlparse.statement.
 *
 * <p>Override extractTableName method to modify the extracted table names (e.g. without com.javaoffers.thrid.sqlparse.schema).
 */
...
public class TablesNamesFinder implements SelectVisitor, FromItemVisitor, ExpressionVisitor, ItemsListVisitor, SelectItemVisitor, StatementVisitor {
     ...
     * (non-Javadoc)
     *
     * @see com.javaoffers.thrid.com.javaoffers.thrid.jsqlparser.com.javaoffers.thrid.sqlparse.expression.ExpressionVisitor#visit(com.javaoffers.thrid.com.javaoffers.thrid.jsqlparser.com.javaoffers.thrid.sqlparse.expression.CaseExpression)
     */
    @Override
     ...
     * (non-Javadoc)
     *
     * @see com.javaoffers.thrid.com.javaoffers.thrid.jsqlparser.com.javaoffers.thrid.sqlparse.expression.ExpressionVisitor#visit(com.javaoffers.thrid.com.javaoffers.thrid.jsqlparser.com.javaoffers.thrid.sqlparse.expression.WhenClause)
     */
    @Override
     ...
     * names. This is only allowed for com.javaoffers.thrid.sqlparse.expression parsing, where a better place for tablenames could
    ...
    public void visit(AlterSystemStatement alterSystemStatement) {
        // no tables involved in this com.javaoffers.thrid.sqlparse.statement
    }
