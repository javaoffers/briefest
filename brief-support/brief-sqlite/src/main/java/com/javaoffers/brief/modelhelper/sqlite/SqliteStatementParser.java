...
public class SqliteStatementParser implements StatementParser<Condition, BaseSQLStatement> , BriefContextPostProcessor {
    ...
    static {
        crudConditionParse.put(SelectConditionParse.conditionTag, new SqliteSelectConditionParse());
        crudConditionParse.put(DeleteConditionParse.conditionTag, new DeleteConditionParse());
        crudConditionParse.put(InsertConditionParse.conditionTag, new SqliteInsertConditionParse());
