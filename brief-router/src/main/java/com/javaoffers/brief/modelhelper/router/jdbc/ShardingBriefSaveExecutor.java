...
public class ShardingBriefSaveExecutor implements SaveExecutor {
    ...
    public ShardingBriefSaveExecutor(DataSource dataSource) {
    ...
    public List<Id> batchSave(BaseSQLInfo sql)  {
        ...
        try {
            ...
            ps = connection.prepareStatement(nativeSql, autoGeneratedKeys);
            ...
            throw new SqlParseException(e.toString(), e);
        } finally {
           ...
           close(connection, oldAutoCommit, ps, rs);
        }
        return ids;
    }
