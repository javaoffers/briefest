...
public class WhereSelectFunImpl<M, V> implements WhereSelectFun<M, V> {
    ...
    @Override
    public WhereSelectFunImpl<M, V> unite(Consumer<WhereSelectFun<M, V>> r) {
    ...
    @Override
    public WhereSelectFunImpl<M, V> unite(boolean condition, Consumer<WhereSelectFun<M, V>> r) {
        if(condition){
            unite(r);
        }
        return this;
    ...
    @Override
    public WhereSelectFunImpl<M, V> condSQL(String sql) {
        conditions.add(new CondSQLCondition(sql));
        return this;
    }

    @Override
    public WhereSelectFunImpl<M, V> condSQL(boolean condition, String sql) {
        if(condition){
            condSQL(sql);
        }
        return this;
    ...
    @Override
    public WhereSelectFunImpl<M, V> condSQL(String sql, Map<String, Object> params) {
        conditions.add(new CondSQLCondition(sql,params));
        return this;
    }

    @Override
    public WhereSelectFunImpl<M, V> condSQL(boolean condition, String sql, Map<String, Object> params) {
        if(condition){
            condSQL(sql, params);
        }
        return this;
    ...
    @Override
    public WhereSelectFun<M, V> lastSQL(String sql) {
        conditions.add(new NativeSQLCondition(sql));
        return this;
    }

    @Override
    public WhereSelectFun<M, V> lastSQL(boolean condition, String sql) {
        if(condition){
            lastSQL(sql);
        }
        return this;
    ...
    @Override
    public WhereSelectFun<M, V> lastSQL(String sql, Map<String, Object> params) {
        conditions.add(new NativeSQLCondition(sql,params));
        return this;
    }

    @Override
    public WhereSelectFun<M, V> lastSQL(boolean condition, String sql, Map<String, Object> params) {
        if(condition){
            lastSQL(sql, params);
        }
        return this;
    ...
    @Override
    public WhereSelectFunImpl<M, V> eq(GetterFun<M, V> col, V value) {
        conditions.add(new WhereOnCondition(col, value, ConditionTag.EQ));
        return this;
    }

    @Override
    public WhereSelectFunImpl<M, V> eq(boolean condition, GetterFun<M, V> col, V value) {
        if (condition) {
            eq(col, value);
        }
        return this;
    ...
    @Override
    public WhereSelectFunImpl<M, V> ueq(GetterFun<M, V> col, V value) {
        conditions.add(new WhereOnCondition(col, value, ConditionTag.UEQ));
        return this;
    }

    @Override
    public WhereSelectFunImpl<M, V> ueq(boolean condition, GetterFun<M, V> col, V value) {
        if (condition) {
            ueq(col, value);
        }
        return this;
    ...
    @Override
    public WhereSelectFunImpl<M, V> gt(GetterFun<M, V> col, V value) {
        conditions.add(new WhereOnCondition(col, value, ConditionTag.GT));
        return this;
    }

    @Override
    public WhereSelectFunImpl<M, V> gt(boolean condition, GetterFun<M, V> col, V value) {
        if (condition) {
            gt(col, value);
        }
        return this;
    ...
    @Override
    public WhereSelectFunImpl<M, V> lt(GetterFun<M, V> col, V value) {
        conditions.add(new WhereOnCondition(col, value, ConditionTag.LT));
        return this;
    }

    @Override
    public WhereSelectFunImpl<M, V> lt(boolean condition, GetterFun<M, V> col, V value) {
        if (condition) {
            lt(col, value);
        }
        return this;
    ...
    @Override
    public WhereSelectFunImpl<M, V> gtEq(GetterFun<M, V> col, V value) {
        conditions.add(new WhereOnCondition(col, value, ConditionTag.GT_EQ));
        return this;
    }

    @Override
    public WhereSelectFunImpl<M, V> gtEq(boolean condition, GetterFun<M, V> col, V value) {
        if (condition) {
            gtEq(col, value);
        }
        return this;
    ...
    @Override
    public WhereSelectFunImpl<M, V> ltEq(GetterFun<M, V> col, V value) {
        conditions.add(new WhereOnCondition(col, value, ConditionTag.LT_EQ));
        return this;
    }

    @Override
    public WhereSelectFunImpl<M, V> ltEq(boolean condition, GetterFun<M, V> col, V value) {
        if (condition) {
            ltEq(col, value);
        }
        return this;
    ...
    @Override
    public WhereSelectFunImpl<M, V> between(GetterFun<M, V> col, V start, V end) {
        conditions.add(new BetweenCondition(col, start, end, ConditionTag.BETWEEN));
        return this;
    }

    @Override
    public WhereSelectFunImpl<M, V> between(boolean condition, GetterFun<M, V> col, V start, V end) {
        if (condition) {
    ...
    @Override
    public WhereSelectFunImpl<M, V> notBetween(GetterFun<M, V> col, V start, V end) {
        conditions.add(new BetweenCondition(col, start, end, ConditionTag.NOT_BETWEEN));
        return this;
    }

    @Override
    public WhereSelectFunImpl<M, V> notBetween(boolean condition, GetterFun<M, V> col, V start, V end) {
        if(condition){
    ...
    @Override
    public WhereSelectFunImpl<M, V> like(GetterFun<M, V> col, V value) {
        conditions.add(new LikeCondition(col, value, ConditionTag.LIKE));
        return this;
    }

    @Override
    public WhereSelectFunImpl<M, V> like(boolean condition, GetterFun<M, V> col, V value) {
        if (condition) {
            like(col, value);
        }
        return this;
    ...
    @Override
    public WhereSelectFunImpl<M, V> likeLeft(GetterFun<M, V> col, V value) {
        conditions.add(new LikeCondition(col, value, ConditionTag.LIKE_LEFT));
        return this;
    }

    @Override
    public WhereSelectFunImpl<M, V> likeLeft(boolean condition, GetterFun<M, V> col, V value) {
        if (condition) {
            likeLeft(col, value);
        }
        return this;
    ...
    @Override
    public WhereSelectFunImpl<M, V> likeRight(GetterFun<M, V> col, V value) {
        conditions.add(new LikeCondition(col, value, ConditionTag.LIKE_RIGHT));
        return this;
    }

    @Override
    public WhereSelectFunImpl<M, V> likeRight(boolean condition, GetterFun<M, V> col, V value) {
        if (condition) {
            likeRight(col, value);
        }
        return this;
    ...
    @Override
    @SafeVarargs
    public final WhereSelectFunImpl<M, V> in(GetterFun<M, V> col, V... values) {
    ...
    @Override
    @SafeVarargs
    public final WhereSelectFunImpl<M, V> in(boolean condition, GetterFun<M, V> col, V... values) {
        if (condition) {
            in(col, values);
        }
        return this;
    ...
    @Override
    @SafeVarargs
    public final WhereSelectFunImpl<M, V> in(GetterFun<M, V> col, Collection... values) {
        conditions.add(new InCondition(col, values, ConditionTag.IN));
        return this;
    }
    ...
    @Override
    @SafeVarargs
    public final WhereSelectFunImpl<M, V> in(boolean condition, GetterFun<M, V> col, Collection... values) {
        if (condition) {
            in(col, values);
        }
        return this;
    ...
    @Override
    @SafeVarargs
    public final WhereSelectFunImpl<M, V> notIn(GetterFun<M, V> col, V... values) {
    ...
    @Override
    @SafeVarargs
    public final WhereSelectFunImpl<M, V> notIn(boolean condition, GetterFun<M, V> col, V... values) {
        if (condition) {
            notIn(col, values);
        }
        return this;
    ...
    @Override
    @SafeVarargs
    public final WhereSelectFunImpl<M, V> notIn(GetterFun<M, V> col, Collection... values) {
        conditions.add(new InCondition(col, values, ConditionTag.NOT_IN));
        return this;
    }
    ...
    @Override
    @SafeVarargs
    public final WhereSelectFunImpl<M, V> notIn(boolean condition, GetterFun<M, V> col, Collection... values) {
        if (condition) {
            notIn(col, values);
        }
        return this;
    ...
    @Override
    @SafeVarargs
    public final WhereSelectFunImpl<M, V> isNull(GetterFun<M, V>... cols) {
    ...
    @Override
    @SafeVarargs
    public final WhereSelectFunImpl<M, V> isNull(boolean condition, GetterFun<M, V>... cols) {
        if(condition){
            isNull(cols);
        }
        return this;
    ...
    @Override
    @SafeVarargs
    public final WhereSelectFunImpl<M, V> isNotNull(GetterFun<M, V>... cols) {
        for(GetterFun<M,V> col: cols){
    ...
    @Override
    @SafeVarargs
    public final WhereSelectFunImpl<M, V> isNotNull(boolean condition, GetterFun<M, V>... cols) {
        if(condition){
            isNull(cols);
        }
        return this;
    ...
    @Override
    @SafeVarargs
    public final WhereSelectFunImpl<M, V> exists(GetterFun<M, V>... cols) {
        for(GetterFun<M,V> col: cols){
    ...
    @Override
    @SafeVarargs
    public final WhereSelectFunImpl<M, V> exists(boolean condition, GetterFun<M, V>... cols) {
        if (condition) {
            exists(cols);
        }
        return this;
    ...
    @Override
    @SafeVarargs
    public final HavingPendingFunImpl<M, GetterFun<M, V>, V> groupBy(GetterFun<M, V>... c) {
    ...
    @Override
    @SafeVarargs
    public final HavingPendingFunImpl<M, GetterFun<M, V>, V> groupBy(String... colSql) {
        conditions.add(new GroupByWordCondition(colSql,ConditionTag.GROUP_BY));
        return new HavingPendingFunImpl<M, GetterFun<M, V>, V>(conditions);
    }

    @Override
    public WhereSelectFunImpl<M, V> limitPage(int pageNum, int size) {
    ...
    @Override
    @SafeVarargs
    public final WhereSelectFunImpl<M, V> orderA(boolean condition, GetterFun<M, V>... getterFuns) {
        if(condition){
            orderA(getterFuns);
        }
        return this;
    ...
    @Override
    @SafeVarargs
    public final WhereSelectFunImpl<M, V> orderD(boolean condition, GetterFun<M, V>... getterFuns) {
        if(condition){
            orderD(getterFuns);
        }
        return this;
    ...
    public int stream(Consumer<M> consumer) {
        BaseBriefImplAdapter instance = BaseBriefImplAdapter.getInstance((HeadCondition) this.conditions.peekFirst());
        SmartSQLInfo sqlStatement = StatementParserAdepter.statementParse(this.conditions);
        return instance.queryStream(sqlStatement, consumer);
    }
}
