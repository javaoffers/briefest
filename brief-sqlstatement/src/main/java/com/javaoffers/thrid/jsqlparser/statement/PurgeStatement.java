...
public class PurgeStatement implements Statement {
    ...
    public PurgeStatement(Table table) {
        ...
        this.object = Objects.requireNonNull(table, "The TABLE of the PURGE TABLE com.javaoffers.thrid.sqlparse.statement must not be null.");
    }
    
    public PurgeStatement(Index index) {
        this.purgeObjectType = PurgeObjectType.INDEX;
        this.object = Objects.requireNonNull(index, "The INDEX of the PURGE INDEX com.javaoffers.thrid.sqlparse.statement must not be null.");
    }
    ...
    public PurgeStatement(PurgeObjectType purgeObjectType, String tableSpaceName, String userName) {
        this.purgeObjectType = purgeObjectType;
        this.object = Objects.requireNonNull(tableSpaceName, "The TABLESPACE NAME of the PURGE TABLESPACE com.javaoffers.thrid.sqlparse.statement must not be null.");
