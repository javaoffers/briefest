...
public class MysqlStatementParser implements StatementParser<Condition,BaseSQLStatement> , BriefContextPostProcessor {
    ...
    public void postProcess(BriefContext briefContext) {
        ...
        statementParserMap.put(DBType.H2, this);
    }
}
