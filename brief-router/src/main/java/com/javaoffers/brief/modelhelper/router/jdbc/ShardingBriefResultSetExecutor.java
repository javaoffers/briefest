 ...
 */
public class ShardingBriefResultSetExecutor implements ResultSetExecutor {

    static Logger logger = LoggerFactory.getLogger(ShardingBriefResultSetExecutor.class);
    ...
    public ShardingBriefResultSetExecutor(ResultSet resultSet) {
