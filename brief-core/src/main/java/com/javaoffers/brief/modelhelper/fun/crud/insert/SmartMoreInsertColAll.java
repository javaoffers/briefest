...
public interface SmartMoreInsertColAll<M, C extends GetterFun<M, Object>, V> {
    /**
     ...
     * @return this
     */
    SmartMoreInsertFun<M, C, V> colAll(M model);
     ...
     * @return this
     */
    SmartMoreInsertFun<M, C, V> colAll(boolean condition, M model);
